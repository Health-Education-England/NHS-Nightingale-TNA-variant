            ...
            <div class="nhsuk-width-container">
                <ol class="nhsuk-breadcrumb__list">
                    ...
                    if ( is_search() ) {
                        ...
                        ?>
                        <li class="nhsuk-breadcrumb__item"><?php echo post_type_archive_title(); ?></li>
                        <?php
                    } else {
                        if (($post_type = get_post_type()) && $post_type !== 'page') {
                            $type = get_post_type_object($post_type);
                            echo '<li class="nhsuk-breadcrumb__item"><a class="nhsuk-breadcrumb__link" href =' . get_post_type_archive_link($post_type) . '>' . $type->label . '</a></li>';
                        }
                        ?>
