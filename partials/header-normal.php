...
<div class="nhsuk-width-container nhsuk-header__container">
    <div class="nhsuk-header__logo">
        ...
        <a href="https://www.hee.nhs.uk/" class="nhsuk-header__link nhsuk-logo__tagline" aria-label="NHS HEE homepage"><?php echo get_bloginfo( 'description' ); ?></a><br>
        <a href="/" class="nhsuk-header__link nhsuk-logo__tagline nhsuk-logo__nameline" aria-label="NHS TNA homepage"><?php echo get_bloginfo( 'name' ); ?></a>
    </div>
